                ...
                <div class="col-md-8 col-sm-12 p-5">
                    ...
                    <form action="login_handler.php" method="post">
                        <div class="form-group text-white">
                            ...
                            <input class="form-control no-border login-input mt-1" type="email" name="email" id="email" autocomplete="off" placeholder="email">

                            <label class="mt-2" for="password">password</label>
                            <input type="password" name="password" id="password" class="form-control no-border login-input mt-1" autocomplete="off" placeholder="password">
                            <br>
